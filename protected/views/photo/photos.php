            ...
            <div class="span8">
                <div class='phoneindex'>
                    ...
                    <div class="photoslist">
                        <li class="unstyled">
                            <a href=""><img src="<?php echo Yii::app()->request->baseUrl.'/uploads/20130926/psb2.png'; ?>" ></a>

                        </li>
                        <li class="unstyled">
                            <a href=""><img src="<?php echo Yii::app()->request->baseUrl.'/uploads/20130926/psb.png'; ?>"></a>
                        ...
                        <li class="unstyled">
                            <a href=""><img src="<?php echo Yii::app()->request->baseUrl.'/uploads/20130926/psb3.jpg'; ?>"></a>
                        </li>
                        <li class="unstyled">
                            <a href=""><img src="<?php echo Yii::app()->request->baseUrl.'/uploads/20130926/psb2.png'; ?>"></a>
                        </li>
